...
if (empty( $adresse ) ||  empty( $sagsnr ) || empty( $book )) {
        ...
        $sql = "INSERT INTO fagforening (adresse, sagsnr, booketmoede, uid) VALUES (?, ?, ?, ?);";
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          ...
          mysqli_stmt_bind_param($stmt, "sssi",$adresse, $sagsnr, $book, $uid);
