...
if ( empty( empty( $adresse ) || $stilling ) || empty( $sagsnr ) || empty( $book )) {
        ...
        $sql = "INSERT INTO jobtilbud (adresse, sagsnr, stilling, booketmoede, uid) VALUES (?, ?, ?, ?, ?);";
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          ...
          mysqli_stmt_bind_param($stmt, "ssssi", $adresse, $sagsnr, $stilling, $book, $uid);
          // Then we execute the prepared statement and send it to the database!
          // This means the user is now registered! :)
          mysqli_stmt_execute($stmt);
			
			
			$subject = "Sag oprettet ".$sagsnr. "af typen privat";
