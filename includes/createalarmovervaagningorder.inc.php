...
$sikkerhedscheck = $_POST['sikkerhedscheck'];
$sagsnr = $_POST['sagsnr'];
...
if ( empty( empty( $kontaktperson ) || $sikkerhedscheck ) || empty( $sagsnr ) || empty( $firmaadresse ) || empty( $fakturaemail ) ) {
	...
	// We check for an invalid e-mail.
        ...
        $sql = "INSERT INTO alarmovervaagning (kontaktperson, sikkerhedscheck, sagsnr, firmaadresse, fakturaemail, ean, website, uid) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          ...
          mysqli_stmt_bind_param($stmt, "sssssisi",$kontaktperson,$sikkerhedscheck, $sagsnr, $firmaadresse, $fakturaemail, $ean, $website, $uid);
