...
if ( empty( empty( $kontaktperson ) || $beskrivelse ) || empty( $sagsnr ) || empty( $firmaadresse ) || empty( $fakturaemail ) ) {
	...
	// We check for an invalid e-mail.
        ...
        $sql = "INSERT INTO digitalisering (kontaktperson, sagsnr, beskrivelse, firmaadresse, fakturaemail, ean, website, uid) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          ...
          mysqli_stmt_bind_param($stmt, "sssssisi",$kontaktperson, $sagsnr,$beskrivelse, $firmaadresse, $fakturaemail, $ean, $website, $uid);
