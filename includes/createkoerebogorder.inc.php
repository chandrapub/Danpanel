...
if ( empty( empty($kontaktperson ) || $beskrivelse ) || empty( $sagsnr ) || empty( $firmaadresse ) || empty( $antal ) || empty( $moede ) ) {
	...
	// We check for an invalid username.
        ...
        $sql = "INSERT INTO koerebog (kontaktperson, sagsnr, beskrivelse, antal, moede, firmaadresse, website, uid) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          ...
          mysqli_stmt_bind_param($stmt, "sssisssi",$kontaktperson, $sagsnr, $beskrivelse, $antal, $moede, $firmaadresse, $website, $uid);
  ...
  header("Location: ../minerhvervprofil.php");
  exit();
